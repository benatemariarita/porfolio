        ...
        <>
            <Fixed>
                ...
                <div className="max-w-screen-md mx-auto">
                    <div className="flex">
                        <img src="/Undestanding The Brand.png" />
                    </div>
                </div>
                ...
                <div className="max-w-screen-md mx-auto">
                    <div className="flex">
                        <img src="/Análise de competidores - image.png" />
                    </div>
                </div>
                ...
                <div className="max-w-screen-md mx-auto">
                    <div className="flex">
                        <img src="/as-luzes.png" />
                    </div>
                </div>
                <div className="max-w-screen-md mx-auto">
                    <div className="flex">
                        <img src="/o-branco.png" />
                    </div>
                </div>
                ...
                <div className="border-1 max-w-screen-md mx-auto pt-14 pb-4">
                    <div className="text-3xl font-medium tracking-wide text-gray-800 pt-6 pb-10">Qual seria o próximo passo deste projeto</div>
